      ...
      <div className="flex flex-col h-full">
         ...
         {selectedPrompt && (
            <Helmet>
               ...
               <meta name="keywords" content={`${selectedPrompt.modelTags?.join(', ')}, ${selectedPrompt.tags?.join(', ')}, AI Prompt, PromptsGo`} />
               ...
               <script type="application/ld+json">
                  {JSON.stringify({
                     ...
                     "description": selectedPrompt.description || selectedPrompt.positive,
                     "image": selectedPrompt.image,
                     "author": {
                        "@type": "Person",
                        "name": selectedPrompt.authorId === 'anonymous' ? 'Anonymous' : 'Community Member'
                     },
                     "dateCreated": new Date(selectedPrompt.createdAt || Date.now()).toISOString(),
                     "keywords": selectedPrompt.modelTags?.join(', ') || "AI Prompt"
                  })}
               </script>
            </Helmet>
         )}
